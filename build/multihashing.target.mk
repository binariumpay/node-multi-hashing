...
OBJS := \
	...
	$(obj).target/$(TARGET)/binarium_hash_v1.o \
	$(obj).target/$(TARGET)/crypto/hashing/streebog/table/stribog.o \
	$(obj).target/$(TARGET)/crypto/hashing/whirlpool/whirlpool.o \
	$(obj).target/$(TARGET)/crypto/hashing/whirlpool/byte_order.o \
	$(obj).target/$(TARGET)/crypto/encryption/gost2015_kuznechik/optimised.o \
	$(obj).target/$(TARGET)/crypto/encryption/gost2015_kuznechik/optimised_tables.o \
	$(obj).target/$(TARGET)/crypto/encryption/gost2015_kuznechik/shared/tables.o \
	$(obj).target/$(TARGET)/crypto/encryption/three_fish/libskein_skein.o \
	$(obj).target/$(TARGET)/crypto/encryption/salsa20/salsa20.o \
	$(obj).target/$(TARGET)/open_ssl/camellia/camellia.o
